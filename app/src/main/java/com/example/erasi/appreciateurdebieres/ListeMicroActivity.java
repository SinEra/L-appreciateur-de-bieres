...
import com.example.erasi.appreciateurdebieres.R;
 ...
 */
public class ListeMicroActivity extends Activity {
    ...
    private class Ecouteur implements AdapterView.OnItemClickListener {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            Intent myIntent1 = new Intent(ListeMicroActivity.this, MicrobrasserieActivity.class);
